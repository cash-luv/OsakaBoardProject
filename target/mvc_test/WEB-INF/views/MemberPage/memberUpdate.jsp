            ...
            <section class="bg-white">
                <div class="container py-4">
                    <div class="row align-items-center justify-content-between">
                        <a class="navbar-brand h1 text-center" href="/member/update">
                            <span class="text-dark h2">회원정보수정</span>
                        </a>
                    </div>
                    <form action="/member/update" method="post" name="updateForm" onsubmit="return ValidationName()">
                        <input type="text" name="member_id" value="${member.member_id}" hidden="hidden">
                        <div class="form-group">
                            <label for="memberId" class="form-label mt-4">아이디</label>
                            <input type="text" class="form-control" id="memberId" name="memberId"
                                   value="${member.memberId}" aria-describedby="emailHelp" readonly>
                            <p id="check-result"></p>
                        </div>

                        <div class="form-group" id="passwordFormGroup">
                            <label class="form-label mt-4" for="nowPasswordCheck">현재 비밀번호 확인</label>
                            <div class="row">
                                <div class="col-8">
                                ...
                                <div class="col-4">
                                    <input type="button" class="btn btn-primary" id="now-password-check"
                                           value="현재 비밀번호 확인" onclick="nowPassword_check()">
                                </div>
                            </div>
                        </div>

                        <div class="form-group" id="passwordCheckFormGroup" style="display: none">
                            <label class="form-label mt-4" for="memberPassword">바꾸실 비밀번호</label>
                            <input type="text" class="form-control " id="memberPassword" name="memberPassword"
                                   onblur="checkPassword()" placeholder="비밀번호 변경 원치 않으시면">
                            <p id="valid-feedback"></p>
                            <label class="form-label mt-4" for="memberPasswordCheck">비밀번호 확인</label>
                            <input type="text" class="form-control " id="memberPasswordCheck" onblur="checkPassword()" placeholder="공백으로 남기시면 됩니다">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="memberName" name="memberName"
                                   value="${member.memberName}" aria-describedby="emailHelp">
                        </div>

                        <div class="form-group">
                            <label class="form-label mt-4">생년월일</label>

                            <input type="text" name="memberBirth" class="form-control" id="memberBirth"
                                   value="${member.memberBirth}" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-auto">
                                    <input type="button" class="btn btn-secondary" onclick="searchAddress()"
                                           value="우편번호 찾기">
                                </div>
                            </div>
                            <input type="text" class="form-control mt-2" id="sample4_roadAddress" name="memberAddress1"
                                   placeholder="도로명주소">
                            <input type="text" class="form-control mt-2" id="sample4_jibunAddress" name="memberAddress2"
                                   placeholder="지번주소">
                            <span id="guide" style="color:#999; display:none"></span>
                            <input type="text" class="form-control mt-2" id="sample4_detailAddress"
                                   name="memberAddress3" placeholder="상세주소">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="memberEmail1" name="memberEmail"
                                       aria-describedby="emailHelp" placeholder="Email">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="emailAddon">@</span>
                                </div>
                                <input type="text" class="form-control" id="emailDomain" name="memberDomain"
                                       placeholder="직접입력">
                        ...
                        <div class="d-grid gap-2">
                            <input class="btn btn-dark btn-lg" type="submit" id="submitBtn" value="수정하기">
                        </div>
                    </form>
                </div>
            </section>
...
<script>
    // 통신사 값 가져오기
    const memberGender = '${member.memberGender}';
    if (memberGender == "남자") {
        $('#memberGender').val('남자').prop("selected", true);
    } else if (memberGender == "여자") {
        $('#memberGender').val('여자').prop("selected", true);
    } else if (memberGender == "비밀") {
        $('#memberGender').val('비밀').prop("selected", true);
    }
    ...
    const nowPassword_check = () => {
        ...
        const passwordUpdate = document.getElementById("passwordCheckFormGroup");
    ...
    const ValidationName = () => {
        ...
        if (memberId.value.length == 0) {
            ...
            Email.focus();
            return false;
        } else if (memberPassword.value == "" && passwordCheck.value == "") {
            memberPassword.value = '${member.memberPassword}';
            alert("회원정보수정완료")
            return true;
        }
    }
    ...
    const checkPassword = () => {
        ...
        if (!password.match(exp)) {
            ...
            validFeedback.style.color = "red";
            validFeedback.innerHTML = "현재 비밀번호와 같습니다";
            return false;
        } else {
